...
const handleRowClick = ( e ) => {
	...
	router.goto('/institution-fieldgroup/' + field_id + '/view');
}

const createRecord = async () => {
    router.goto('/institution-new-fieldgroup');
}
...
<div style="text-align: center;" class="mdc-typography--headline4">INSTITUTION FIELDGROUPS</div>
<Paper>
