...
import InstitutionViewFieldgroup from './InstitutionViewFieldgroup.svelte';
...
const tab_change = (t) => {
    if ( t ) {
        router.goto('/institution-fieldgroup/' + meta.params.id + t.mode);
    }
}
...
<TabBar tabs={tabs} let:tab bind:active>
    ...
    <Route path="/view"> <InstitutionViewFieldgroup {meta} /> </Route>
    <Route path="/edit"> <InstitutionEditFieldgroup {meta} /> </Route>
    <Route fallback> <InstitutionViewFieldgroup {meta} /> </Route>
