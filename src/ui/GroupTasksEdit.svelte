...
import { getTask, getTasks, getMembers, getGroup, getGroups } from '../utils/pnb-api.js';
import { convertTasks, convertMembers, convertTask } from '../utils/pnb-convert.js';
...
let member = false, members = false;
let title = '', subtitle = '';
...
const updateTask = async () => {
	...
	const data = { id: task_id, task_id: new_task_value.id, group_id: new_group_value, member_id: new_member_value.id, fte: new_fte_value, begin_time: new_begin_time, end_time: new_end_time, validated: new_validated };
