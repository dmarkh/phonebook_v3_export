...
import { getDocumentFields } from '../utils/pnb-api.js';
...
const handleRowClick = ( e ) => {
	...
	router.goto('/document-field/' + field_id + '/view');
}

const createRecord = async () => {
    router.goto('/document-new-field');
}
...
<div style="text-align: center;" class="mdc-typography--headline4">DOCUMENT FIELDS</div>
