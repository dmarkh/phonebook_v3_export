...
import { getEventFields } from '../utils/pnb-api.js';
...
const handleRowClick = ( e ) => {
	...
	router.goto('/event-field/' + field_id + '/view');
}

const createRecord = async () => {
    router.goto('/event-new-field');
}
...
<div style="text-align: center;" class="mdc-typography--headline4">EVENT FIELDS</div>
