...
import InstitutionViewField from './InstitutionViewField.svelte';
...
const tab_change = (t) => {
    if ( t ) {
        router.goto('/institution-field/' + meta.params.id + t.mode);
    }
}
...
<TabBar tabs={tabs} let:tab bind:active>
    ...
    <Route path="/view"> <InstitutionViewField {meta} /> </Route>
    <Route path="/edit"> <InstitutionEditField {meta} /> </Route>
    <Route fallback> <InstitutionViewField {meta} /> </Route>
