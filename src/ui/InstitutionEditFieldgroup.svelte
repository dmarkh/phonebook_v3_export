...
import { getInstitutionFieldgroups, updateInstitutionFieldgroups } from '../utils/pnb-api.js';
...
const updateRecord = async () => {
    ...
    let rc = await updateInstitutionFieldgroups( data );

	await sleep(1000);
	router.goto( '/institution-fieldgroup/' + meta.params.id + '/view' );
	pleaseWait = false;
}
