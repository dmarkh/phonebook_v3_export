...
const updateTask = async () => {
	...
	const data = { id: task_id, task_id: new_task_value.id, group_id: new_group_value.id, member_id: new_member_id, fte: new_fte_value, begin_time: new_begin_time, end_time: new_end_time };
...
const getMemberInfo = async () => {
	...
	if ( assignedtask ) {
		new_member_id = assignedtask.member_id;
