...
import DocumentViewField from './DocumentViewField.svelte';
...
const tab_change = (t) => {
    if ( t ) {
        router.goto('/document-field/' + meta.params.id + t.mode);
    }
}
...
<TabBar tabs={tabs} let:tab bind:active>
    ...
    <Route path="/view"> <DocumentViewField {meta} /> </Route>
    <Route path="/edit"> <DocumentEditField {meta} /> </Route>
    <Route fallback> <DocumentViewField {meta} /> </Route>
